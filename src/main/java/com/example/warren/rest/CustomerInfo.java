...
public class CustomerInfo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        try{
        	cust_Helper = new DatabaseHelper(CustomerInfo.this);
       ...
       //load form widget
        mClass = new ModelClass(c_name,c_phone,c_mail,c_addrs);
        save=(Button)findViewById(R.id.Save);
        this.cust_name = (EditText)findViewById(R.id.cust_name);
        this.cust_email =(EditText)findViewById(R.id.cust_email);
        this.cust_phone =(EditText)findViewById(R.id.cust__number);
        this.cust_address =(EditText)findViewById(R.id.cust_adress);
			...
			public void onClick(View v) {
			 ...
			 mClass.setAddress(c_addrs);
    		   if(c_name.equals("")||c_mail.equals("")||c_phone.equals("") || c_addrs.equals("")){
    			  Toast.makeText(CustomerInfo.this, "All fields are Mandatory", Toast.LENGTH_LONG).show();
    		   }
    		   else{
